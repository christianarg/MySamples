...
test('GroupBy', function () {
    ...
    var pacoluis = Enumerable.From(groupedByPaco).Where(function (p) { return p.apellido == 'luis'; }).SingleOrDefault(null);
    ok(pacoluis != null);
    var pacovanderjose = Enumerable.From(groupedByPaco).Where(function (p) { return p.apellido == 'van der jose'; }).SingleOrDefault(null);
